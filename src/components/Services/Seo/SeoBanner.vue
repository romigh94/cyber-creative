<template>
  <section class="relative pb-20 xl:pb-32 overflow-hidden">
    <img class="absolute bottom-0 left-0 w-full h-full object-cover" src="https://images.unsplash.com/photo-1511649475669-e288648b2339?crop=entropy&cs=srgb&fm=jpg&ixid=M3wzMzIzMzB8MHwxfHNlYXJjaHwxMTd8fHdlYiUyMGRldmVsb3BtZW50fGVufDB8fHx8MTcwOTUxNjcxOXww&ixlib=rb-4.0.3&q=85&w=1920" alt="">
    <nav class="py-6 mb-12 md:mb-24 bg-white">
    ...
    <div class="container px-4 mx-auto relative">
      <div class="max-w-4xl mx-auto text-center">
        <h1 class="font-heading text-5xl xs:text-6xl md:text-8xl xl:text-10xl font-bold text-gray-900 mb-8 sm:mb-14">
          <span contenteditable="false">World Best Tech Startup</span>
          <span class="font-serif italic">Ever</span>
        </h1>
        <a class="relative group inline-block w-full sm:w-auto py-4 px-7 mb-24 text-white font-semibold bg-orange-900 rounded-md overflow-hidden" href="#">
